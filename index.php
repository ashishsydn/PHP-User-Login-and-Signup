...
<body class="bg-gradient-to-r from-[#00aaff] to-[#00ff6c]">
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <img src="../images/logo.png" class="h-8 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PHPLogin</span>
            </a>
    ...
    <main>
        <div class="bg-gray-50 border border-gray-200 px-10 py-5 rounded max-w-lg mx-auto my-16">
            <header class="text-center">
                <h2 class="mb-1 text-2xl font-bold uppercase">Register</h2>
                <p class="mb-4">Create your account to take the quiz and save your scores</p>
            </header>

            <form method="POST" action="/users">
                <div class="mb-4">
                    <label class="inline-block text-lg mb-2" for="name">Name</label>
                    <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name" placeholder="Enter your name">
                </div>
                <div class="mb-4">
                    <label class="inline-block text-lg mb-2" for="email">Email</label>
                    <input type="email" class="border border-gray-200 rounded p-2 w-full" name="email" placeholder="Your email goes here">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label class="inline-block text-lg mb-2" for="password2">Confirm Password</label>
                    <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password2">
                </div>
                <div class="mb-4">
                    <button class="bg-red-500 text-white rounded py-2 px-4 hover:bg-black" name="submit" type="submit">Sign Up</button>
                </div>
            </form>
