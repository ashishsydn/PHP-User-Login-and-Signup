    ...
    <main>
        <div class="bg-gray-50 border border-gray-200 px-10 py-5 rounded max-w-lg mx-auto my-16">
            <header class="text-center">
                <h2 class="mb-4 text-4xl">Login</h2>
                <p class="mb-4">Log into your account to manage your scores</p>
            </header>
            ...
            <form method="POST">
                ...
                <div class="mb-4">
                    <button class="bg-red-500 text-white rounded py-2 px-4 hover:bg-black" name="submit" type="submit">Sign In</button>
                </div>
            </form>
